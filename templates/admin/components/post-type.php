...
<div class="post-type-item d-flex justify-content-between p-3 bg-light rounded border mb-3">
    ...
    <div class="post-type-actions">
        <div class="d-flex">
            <a class="btn btn-outline-secondary btn-sm me-2" href="<?= admin_url('admin.php?page=' . EXPORT_ANYTHING_SLUG . '&action=edit&id=' . $post_type->id) ?>">Edit</a>
            <a class="btn btn-primary btn-sm" href="<?= admin_url('admin.php?page=' . EXPORT_ANYTHING_SLUG . '&action=view&id=' . $post_type->id) ?>">Exports</a>
        </div>
    </div>
</div>